...
/**
 * Use this functional component to render a spot
 * @param props 
 * @returns 
 */
export default function Spot(props: OrderBookProps) {
  const [focused, setFocused] = React.useState("orderbook");

  return (
    <div className="border-t-2 border-white">
      <div className="flex items-center gap-10 justify-start p-3 text-white text-[18px]">
        <p>Limit</p>
        <p>Market</p>
        <p>Stop-limit</p>
      </div>
      ...
      <div className="w-full p-3 text-center text-white">
        <div className="flex border-2 border-white text-[18px] p-2 justify-between gap-1 rounded-lg">
        ...
        <div className="flex border-2 border-white text-[18px] p-2 justify-between gap-1 mt-3 rounded-lg">
        ...
        <div className="flex border-2 border-white text-[18px] p-2 justify-between gap-1 mt-8 rounded-lg">
      ...
      <div className="mt-5 border-t-2 border-white">
        <div className="flex">
          <div onClick={()=>setFocused("orderbook")} className={`text-center font-bold w-auto h-[50px] cursor-pointer p-3 ${focused === "orderbook" ? " border-t-4 text-white border-purple-500" :"text-white"}`}>ORDER BOOK</div>
        </div>
        <div className="border-t-2 border-white">
          ...
          <div className="">
            {
              props.orderBook.BID.map((bid, index)=>{
                if(index % 2 === 0){
                    return (
          ...
          <div className="">
            {
              props.orderBook.ASK.map((bid, index)=>{
                if(index % 2 === 0){
                  return (
                    <div className="flex justify-between text-[18px] bg-[#232323] pl-3 pr-3 pt-1 pb-1">
